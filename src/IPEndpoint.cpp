...
Network::IPEndpoint::IPEndpoint(sockaddr_in *address) {
    if (address == nullptr) {
        return;
    }
...
Network::IPEndpoint::IPEndpoint(sockaddr_in6 *address) {
    if (address == nullptr) {
        return;
    }
...
bool Network::IPEndpoint::solveIPv4(sockaddr_in *address) {
    in_addr inAddress{};
...
bool Network::IPEndpoint::solveIPv6(sockaddr_in6 *address) {
    in6_addr inAddress{};
